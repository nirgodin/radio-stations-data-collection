...
class SpotifyInsertersComponentFactory:
    ...
    @staticmethod
    def get_spotify_artists_inserter(spotify_client: SpotifyClient, db_engine: AsyncEngine) -> SpotifyArtistsDatabaseInserter:
    ...
    @staticmethod
    def get_spotify_tracks_inserter(db_engine: AsyncEngine) -> SpotifyTracksDatabaseInserter:
        return SpotifyTracksDatabaseInserter(db_engine)

    @staticmethod
    def get_audio_features_inserter(spotify_client: SpotifyClient, db_engine: AsyncEngine) -> SpotifyAudioFeaturesDatabaseInserter:
        return SpotifyAudioFeaturesDatabaseInserter(spotify_client=spotify_client, db_engine=db_engine)

    @staticmethod
    def get_track_id_mapping_inserter(db_engine: AsyncEngine) -> TrackIDMappingDatabaseInserter:
