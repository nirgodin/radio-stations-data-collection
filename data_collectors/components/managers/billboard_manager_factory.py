...
class BillboardManagerFactory(BaseManagerFactory):
    def get_billboard_manager(
        ...
        return BillboardManager(
            ...
            charts_collector=self.collectors.billboard.get_charts_collector(
                client_session
            ),
            tracks_collector=self.collectors.billboard.get_tracks_collector(
                client_session, spotify_client
            ),
