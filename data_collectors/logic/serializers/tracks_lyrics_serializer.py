...
from data_collectors.tools import LanguageDetector
...
class TracksLyricsSerializer(ISerializer):
    ...
    def _serialize_single_track_lyrics(self,
        ...
        joined_lyrics = "\n".join(lyrics)
        lyrics_language = self._language_detector.detect_language(joined_lyrics)
        ...
        return TrackLyrics(
            ...
            language=lyrics_language["language"],
            language_confidence=lyrics_language["score"],
