...
from genie_datastores.postgres.models import SpotifyArtist, SpotifyTrack, AudioFeatures, Track, TrackIDMapping, \
    SpotifyAlbum
...
class SpotifyInsertionsVerifier:
    ...
    async def _inserted_expected_track_id_mapping_records(self, expected: List[List[str]]) -> bool:
